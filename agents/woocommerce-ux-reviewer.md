...
You have a persistent, file-based memory system at `~/.claude/agent-memory/woocommerce-ux-reviewer/`. Create this directory if it doesn't exist, then write to it directly with the Write tool.
